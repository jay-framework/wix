...
process.env.JAY_BACKEND_DIR = process.env.JAY_BACKEND_DIR || "/Users/yoav/work/jay/wix/examples/studio-store/build/v2.0.0/backend";
const entry = await import("./entry.mjs");
const handler = entry.default?.fetch || entry.fetch;
const PORT = parseInt(process.env.PORT || "4000", 10);
const FRONTEND_DIR = "/Users/yoav/work/jay/wix/examples/studio-store/build/v2.0.0/frontend";
