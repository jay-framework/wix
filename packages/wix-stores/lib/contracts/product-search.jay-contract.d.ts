...
export type ProductSearchSlowViewState = Pick<
    ProductSearchViewState,
    'searchFields' | 'fuzzySearch' | 'emptyStateMessage'
> & {
    filters: {
        categoryFilter: {
            categories: Array<
                Pick<
                    ...
                    'categoryId' | 'categoryName' | 'categorySlug' | 'categoryUrl'
                >
            >;
        };
    };
...
export type ProductSearchFastViewState = Pick<
    ProductSearchViewState,
    | 'searchExpression'
    | 'isSearching'
    | 'hasSearched'
...
export type ProductSearchInteractiveViewState = Pick<
    ProductSearchViewState,
    | 'searchExpression'
    | 'isSearching'
    | 'hasSearched'
...
export interface ProductSearchRefs {
    ...
    filters: {
        ...
        priceRange: {
            minPrice: HTMLElementProxy<
                PriceRangeOfFilterOfProductSearchViewState,
                HTMLInputElement
            >;
            maxPrice: HTMLElementProxy<
                PriceRangeOfFilterOfProductSearchViewState,
                HTMLInputElement
            >;
            ranges: {
                isSelected: HTMLElementCollectionProxy<
                    RangeOfPriceRangeOfFilterOfProductSearchViewState,
                    HTMLInputElement
                >;
            };
        };
        categoryFilter: {
            categories: {
                isSelected: HTMLElementCollectionProxy<
                    CategoryOfCategoryFilterOfFilterOfProductSearchViewState,
                    HTMLInputElement
                >;
            };
        };
        optionFilters: {
            choices: {
                isSelected: HTMLElementCollectionProxy<
                    ChoiceOfOptionFilterOfFilterOfProductSearchViewState,
                    HTMLInputElement
                >;
            };
        };
    ...
    suggestions: {
        suggestionButton: HTMLElementCollectionProxy<
            SuggestionOfProductSearchViewState,
            HTMLButtonElement
        >;
    };
}
...
export interface ProductSearchRepeatedRefs {
    ...
    filters: {
        ...
        priceRange: {
            minPrice: HTMLElementCollectionProxy<
                PriceRangeOfFilterOfProductSearchViewState,
                HTMLInputElement
            >;
            maxPrice: HTMLElementCollectionProxy<
                PriceRangeOfFilterOfProductSearchViewState,
                HTMLInputElement
            >;
            ranges: {
