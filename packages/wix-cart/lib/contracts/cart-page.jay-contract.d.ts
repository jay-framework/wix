...
export type CartPageFastViewState = Pick<
    CartPageViewState,
    'isEmpty' | 'isLoading' | 'isCheckingOut'
> & {
...
export type CartPageInteractiveViewState = Pick<
    CartPageViewState,
    'isEmpty' | 'isLoading' | 'isCheckingOut'
> & {
    lineItems: Array<CartPageViewState['lineItems'][number]>;
...
export type CartPageContract = JayContract<
    CartPageViewState,
    CartPageRefs,
    CartPageSlowViewState,
    CartPageFastViewState,
    CartPageInteractiveViewState
>;
